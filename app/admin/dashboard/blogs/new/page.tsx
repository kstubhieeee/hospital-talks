...
export default function NewBlog() {
  ...
  // Initialize with structure matching the specified blog layout
  const [formData, setFormData] = useState<Blog>({
    ...
    sections: [
      // First section (after title/featured image) with headline2
      { id: "section-1", headline: "", paragraph: "" },
      // Second section with headline3
      { id: "section-2", headline: "", paragraph: "" },
    ],
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Add the new blog with a new ID
      const newBlog: Blog = {
        ...formData,
        id: structuredBlogArticles.length + 1, // Simple ID generation for demo
      };
      
      // In a real application, you would update this in a database
      // Here, we'd add the new blog to our structuredBlogArticles array
      
      toast({
        title: "Blog created",
        description: "Your blog article has been saved successfully."
      });
      ...
      <header className="sticky top-0 z-40 border-b bg-background">
        <div className="container flex h-16 items-center justify-between py-4">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold">New Blog Article</h1>
          </div>
          <Button 
            variant="ghost" 
            size="icon" 
      ...
      <main className="flex-1 p-6 container">
        ...
        >
          <form onSubmit={handleSubmit}>
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Blog Structure</CardTitle>
              </CardHeader>
